...
It provides a way to apply a set of coefficeints to a basis, access to individual basis functions, and a way to compute a kernel matrix combining the basis functions with a forward measurement model.
